...
public class SavedPostAdapter extends RecyclerView.Adapter<SavedPostAdapter.ViewHolder> {
    ...
    public SavedPostAdapter(Context context, int post_item, List<Post> postArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.saved_post_item, parent,
                false);
        SavedPostAdapter.ViewHolder vh = new SavedPostAdapter.ViewHolder(v);
        return vh;
    }
